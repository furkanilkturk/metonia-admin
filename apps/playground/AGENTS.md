...
- Docker: `disabled`
- Users resource: `disabled`; the canonical Users example is omitted, so add a resource only through the same shared/server/client/route boundaries
